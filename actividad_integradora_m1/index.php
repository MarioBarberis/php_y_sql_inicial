...
<body>
    ...
    <section class="bucle"> <!-- aplicando WHILE
 -->
        <div class = "lowcost">

            <p>Aquí podrás ver los viajes LOW COST por temporada (menos de $30 USD):</p>

            <?php
            while ($dolar_1 <= 30) {
                echo " - $viaje_1 está entre los más económicos. <br>";
                break;
            }
            while ($dolar_2 <= 30) {
                echo " - $viaje_2 está entre los más económicos. <br>";
                break;
            }
            while ($dolar_3 <= 30) {
                echo " - $viaje_3 está entre los más económicos. <br>";
                break;
            }
            while ($dolar_4 <= 30) {
                echo " - $viaje_4 está entre los más económicos. <br>";
                break;
            }
